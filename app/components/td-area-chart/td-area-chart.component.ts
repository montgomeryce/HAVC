...
import {TDAreaChartConfig} from './td-area-chart-config';
...
@Component({
    ...
    styleUrls: ['td-area-chart.component.css'],
    directives: []
})

export class TDAreaChartComponent {

    @Input() config: Array<TDAreaChartConfig>;
